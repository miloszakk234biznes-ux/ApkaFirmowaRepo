/**
 * Plik: components/ui/dropdown-menu.tsx
 * Cel: Komponenty DropdownMenu (shadcn/ui) — używane w menu użytkownika i
 *      przełączniku motywu.
 * Zależności: @radix-ui/react-dropdown-menu, lucide-react, lib/utils.
 */
'use client';
