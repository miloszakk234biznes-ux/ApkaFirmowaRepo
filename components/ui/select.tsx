/**
 * Plik: components/ui/select.tsx
 * Cel: Pole wyboru (shadcn/ui) oparte o Radix Select — statusy, priorytety,
 *      formy płatności, przypisanie pracownika.
 * Zależności: @radix-ui/react-select, lucide-react, lib/utils.
 */
'use client';
