/**
 * Plik: components/ui/sheet.tsx
 * Cel: Panel boczny (shadcn/ui) — panel dnia w kalendarzu (mobile/desktop).
 * Zależności: @radix-ui/react-dialog, class-variance-authority, lucide-react.
 */
'use client';
